...
CLINICAL_INPUT="./data/linked_to_ontologies/mapped_clinical_data_umls.csv"
...
CLINICAL_OUTPUT="./data/linked_to_ontologies/mapped_clinical_drug_data_with_umls_parents.csv"
