...
def main():
    ...
    print(f"Total unique MONDO IDs in clinical data: {len(ids_clinical)}")
    print(f"Total unique MONDO IDs in preclinical data: {len(ids_preclinical)}")
    print(f"Total unique MONDO IDs across both datasets: {len(all_mondo_ids)}")
