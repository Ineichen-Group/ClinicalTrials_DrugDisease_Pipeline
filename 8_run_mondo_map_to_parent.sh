...
CLINICAL_INPUT="./data/linked_to_ontologies/mapped_clinical_data_mondo_cleaned.csv"
...
# ---- outputs ----
CLINICAL_OUTPUT="./data/linked_to_ontologies/mapped_clinical_data_mondo_cleaned_with_mondo_parents.csv"
